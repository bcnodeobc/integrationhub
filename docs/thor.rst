...
Api for this rpc::
    ...
    http://integrationhub.okwave.asia:3333/api/v2/thorhammer/web3.eth/deploySC
...
example::
    ...
    var options = {
        'method': 'POST',
        'url': 'http://integrationhub.okwave.asia:3333/api/v2/thorhammer/web3.eth/deploySC',
        'headers': {
            'Authorization': 'OBC eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoib2JjIiwiaWF0IjoxNjAzNzYyNjY5LCJleHAiOjE2MDQzNjc0Njl9.L9MEaOdEgKPk-eVHdldaMw5I_XmKgUJwHg3aV4HVvsU',
            'Content-Type': 'application/json'
    },
...
Api for this rpc::
    ...
    http://integrationhub.okwave.asia:3333/api/v2/thorhammer/web3.eth/deploySCHex
...
example::
    ...
    var options = {
        'method': 'POST',
        'url': 'http://integrationhub.okwave.asia:3333/api/v2/thorhammer/web3.eth/deploySCHex',
        'headers': {
            'Authorization': 'OBC eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoib2JjIiwiaWF0IjoxNjAzNzYyNjY5LCJleHAiOjE2MDQzNjc0Njl9.L9MEaOdEgKPk-eVHdldaMw5I_XmKgUJwHg3aV4HVvsU',
            'Content-Type': 'application/json'
    },
...
Api for this rpc::
    ...
    http://integrationhub.okwave.asia:3333/api/v2/thorhammer/web3.eth/callSC
...
example::
    ...
    var options = {
        'method': 'POST',
        'url': 'http://integrationhub.okwave.asia:3333/api/v2/thorhammer/web3.eth/callSC',
        'headers': {
            'Authorization': 'OBC eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoib2JjIiwiaWF0IjoxNjAzNzYyNjY5LCJleHAiOjE2MDQzNjc0Njl9.L9MEaOdEgKPk-eVHdldaMw5I_XmKgUJwHg3aV4HVvsU',
            'Content-Type': 'application/json'
    },
...
Api for this rpc::
    ...
    http://integrationhub.okwave.asia:3333/api/v2/thorhammer/web3.eth/sendSC
...
example::
    ...
    var options = {
        'method': 'POST',
        'url': 'http://integrationhub.okwave.asia:3333/api/v2/thorhammer/web3.eth/sendSC',
        'headers': {
            'Authorization': 'OBC eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoib2JjIiwiaWF0IjoxNjAzNzYyNjY5LCJleHAiOjE2MDQzNjc0Njl9.L9MEaOdEgKPk-eVHdldaMw5I_XmKgUJwHg3aV4HVvsU',
            'Content-Type': 'application/json'
    },
